namespace miBoda.ViewModels
{
    ...
    public class MainViewModel : ViewModelBase //INotifyPropertyChanged //ViewModelBase
    {
        #region Events
        ...
        public ObservableCollection<Rate> Rates
        {
            ...
            set
            {
                ...
                {
                    _rates = value;
                    RaisePropertyChanged(nameof(Rates));
                    PropertyChanged?.Invoke(
                        this,
        ...
        public Rate SourceRate
        {
            ...
            set
            {
                ...
                {
                    _sourceRate = value;
                    RaisePropertyChanged(nameof(SourceRate));
                    PropertyChanged?.Invoke(
                        this,
        ...
        public Rate TargetRate
        {
            ...
            set
            {
                ...
                {
                    _targetRate = value;
                    RaisePropertyChanged(nameof(TargetRate));
                    PropertyChanged?.Invoke(
                        this,
